    ...
    <section className="poppins-regular relative bg-white overflow-hidden pt-10 pb-16 lg:pt-10 lg:pb-32 font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="flex-1 flex flex-col justify-center items-start w-full">
          ...
          {/* Eyebrow Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-white border border-[#80A33C]/20 shadow-sm text-[#80A33C] text-sm font-bold tracking-wide">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[4rem] font-extrabold text-gray-900 leading-[1.1] tracking-tight mb-6">
            {headlinePrefix}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full sm:w-auto">
            ...
            >
              {ctaText}
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 transform transition-transform duration-300 group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
