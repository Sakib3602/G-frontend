        ...
        <div className="hidden lg:flex lg:w-5/12 bg-gray-900 p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 mt-auto">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
              Join thousands of forward-thinking companies relying on our next-gen digital solutions and secure IT architecture.
            </p>
          </div>
        </div>
        ...
        <div className="w-full lg:w-7/12 p-6 sm:p-12 lg:p-16 flex flex-col justify-center bg-white relative z-10">
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mb-8 sm:mb-10 text-center lg:text-left">
              <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-2 tracking-tight">Create an account</h1>
              <p className="text-gray-500 text-sm">Enter your details to securely access your portal.</p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1.5" htmlFor="confirm-password">Confirm Pass</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                      <svg className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <div className="mt-6">
                <div className="flex items-start group">
                  ...
                  <label htmlFor="terms" className="ml-3 text-sm text-gray-600 cursor-pointer group-hover:text-gray-900 transition-colors">
                    I accept the <a href="#" className="font-bold text-[#80A33C] hover:text-[#6b8932] transition-colors">Terms & Conditions</a> and <a href="#" className="font-bold text-[#80A33C] hover:text-[#6b8932] transition-colors">Privacy Policy</a>.
                  </label>
                </div>
                {errors.terms && <p className="mt-1.5 text-xs text-red-500 font-medium">{errors.terms.message}</p>}
              </div>
